...
### Get to know about all these vars in depth from our Docs.

## Mandatory Vars

- These are the minimum required vars need to setup to make Prime Music Bot functional.

1. `API_ID` : Get it from my.telegram.org 
2. `API_HASH`  : Get it from my.telegram.org 
3. `BOT_TOKEN` : Get it from [@Botfather](http://t.me/BotFather) in Telegram
4. `MONGO_DB_URI` : Get mongo db [from here.](https://mongodb.com)
...
- You can play tracks or playlists from spotify from Prime Music bot
...
- If you plan to use Prime Music Bot with your own customized or modified code.
...
- You can change images which are used in Prime Music Bot.
